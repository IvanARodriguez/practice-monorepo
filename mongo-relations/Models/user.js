...
const userSchema = new mongoose.Schema({
	first: { type: String, required: true, unique: true },
	...
	addresses: [
		{
			...
			zipCode: { type: Number, required: true, maxlength: 5 },
		},
	],
});
...
// Seed data for Example purposes
// One to Some relationship - In Document Relation
const newUser = await makeUser()
await addAddress(newUser.id)
